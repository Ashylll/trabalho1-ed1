...
/* 
    saida.h
    Módulo responsável pela criação e gerenciamento de saídas
...
/* Incrementam os contadores de formas esmagadas, número de instruções, de disparos e de formas clonadas */
...
// Insere uma marca visual (asterisco vermelho) no local da forma esmagada
...
// Registra o log do comando na saída. Recebe string e uma lista variável de argumentos
